import {ICategory, IRef} from '../Interfaces';
...
export const categorys: ICategory[] = [
  {
    ...
    text: 'daire',
    image:
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQO-tyJjakgGm13qM5nUEKpmDAZgecKtYNaQg&usqp=CAU',
